...
class tDAL
{
	...
	function FillTablesList()
	{
		...
		$this->lstTables[] = array("name" => "almovconsdiae", "varname" => "dbrf_at_127_0_0_1__almovconsdiae", "altvarname" => "almovconsdiae", "connId" => "dbrf_at_127_0_0_1", "schema" => "", "connName" => "dbrf");
		...
		$this->lstTables[] = array("name" => "q_ctrl_numasientos", "varname" => "dbrf_at_127_0_0_1__q_ctrl_numasientos", "altvarname" => "q_ctrl_numasientos", "connId" => "dbrf_at_127_0_0_1", "schema" => "", "connName" => "dbrf");
